...
Для отправки запросов можно использовать графический интерфейс Swagger UI. Чтобы отправить запрос, нужно нажать **Try it out**, затем заполнить поля и нажать **Execute**.
